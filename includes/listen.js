...
(async function () {
  ...
  /////////////////////////////////////////////////
    ...
    if (!data.includes(event.threadID) && !adminBot.includes(event.senderID)) {
      ...
      if (event.body && event.body.startsWith(prefix)) return api.sendMessage(`Your Box Has Not Been Approved Yet. To Submit A Request For Approval, Please Type On Your Thread: ${prefix}request\n\n-‘๑’-Admin FB  Link:\n https://www.facebook.com/100077357343941`, event.threadID);
    };
    switch (event.type) {
      case "message":
      case "message_reply":
